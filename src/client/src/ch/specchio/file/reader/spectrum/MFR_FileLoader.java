...
public class MFR_FileLoader extends SpectralFileLoader {
	...
	public MFR_FileLoader(SPECCHIOClient specchio_client, SpecchioCampaignDataLoader campaignDataLoader)
	{
		super("MFR Out File", specchio_client, campaignDataLoader);
	}
