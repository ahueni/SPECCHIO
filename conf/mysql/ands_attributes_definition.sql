...
-- two-digit FOR codes
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '01 Mathematical sciences', '01', 'Mathematical sciences');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '02 Physical sciences', '02', 'Physical sciences');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '03 Chemical sciences', '03', 'Chemical sciences');
...
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '06 Biological sciences', '06', 'Biological sciences');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '07 Agricultural and veterinary sciences', '07', 'Agricultural and veterinary sciences');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '08 Information and computing sciences', '08', 'Information and computing sciences');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '09 Engineering', '09', 'Engineering');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '10 Technology', '10', 'Technology');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '11 Medical and health sciences', '11', 'Medical and health sciences');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '12 Built environment and design', '12', '12 Built environment and design');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '13 Education', '13', 'Education');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '14 Economics', '14', 'Economics');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '15 Commerce, management, tourism, and services', '15', 'Commerce, management, tourism, and services');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '16 Studies in human society', '16', 'Studies in human society');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '17 Psychology and cognitive sciences', '17', 'Psychology and cognitive sciences');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '18 Law and legal studies', '18', 'Law and legal studies');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '19 Studies in creative arts and writing', '19', 'Studies in creative arts and writing');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '20 Language, communication and culture', '20', 'Language, communication and culture');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '21 History and archaeology', '21', 'History and archaeology');
INSERT INTO `specchio`.`taxonomy` (`attribute_id`, `name`, `code`, `description`) VALUES ((select `attribute_id` from `specchio`.`attribute` where name = 'FOR Code'), '22 Philosophy and religious studies', '22', 'Philosophy and religious studies');
