...
--
-- Temporary table structure for view `environmental_condition_view`
--

DROP TABLE IF EXISTS `environmental_condition_view`;
/*!50001 DROP VIEW IF EXISTS `environmental_condition_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `environmental_condition_view` (
  `environmental_condition_id` int(10) unsigned,
  `ambient_temperature` float,
  `air_pressure` int(10) unsigned,
  `relative_humidity` float,
  `wind_direction_id` int(10) unsigned,
  `wind_speed_id` int(10) unsigned,
  `cloud_cover_id` int(10) unsigned,
...
INSERT INTO `unit` VALUES (1,'g','Gram','g',NULL),(2,'kg','Kilogram','kg',NULL),(3,'%','Percent','%',NULL),(4,NULL,NULL,'Date',NULL),(5,NULL,NULL,'String',NULL);
/*!40000 ALTER TABLE `unit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `instrument_setting`
--

DROP TABLE IF EXISTS `instrument_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `instrument_setting` (
  `instrument_setting_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` float NOT NULL,
  `type` int(11) NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`instrument_setting_id`),
  KEY `specchio_user_fk` (`user_id`),
  KEY `instr_setting_type_fk` (`type`),
  CONSTRAINT `specchio_user_fk` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
  CONSTRAINT `instr_setting_type_fk` FOREIGN KEY (`type`) REFERENCES `instr_setting_type` (`instr_setting_type_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `instrument_setting`
--

LOCK TABLES `instrument_setting` WRITE;
/*!40000 ALTER TABLE `instrument_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `instrument_setting` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sdb_admin`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`instrument_setting_tr` BEFORE INSERT ON `instrument_setting` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Table structure for table `sampling_geometry`
--

DROP TABLE IF EXISTS `sampling_geometry`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sampling_geometry` (
  `sampling_geometry_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `sensor_zenith` float DEFAULT NULL,
  `sensor_azimuth` float DEFAULT NULL,
  `illumination_zenith` float DEFAULT NULL,
  `illumination_azimuth` float DEFAULT NULL,
  `sensor_distance` float DEFAULT NULL,
  `illumination_distance` float DEFAULT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`sampling_geometry_id`),
  KEY `FK_sampling_geometry_user_id` (`user_id`),
  CONSTRAINT `FK_sampling_geometry_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `sampling_geometry`
--

LOCK TABLES `sampling_geometry` WRITE;
/*!40000 ALTER TABLE `sampling_geometry` DISABLE KEYS */;
/*!40000 ALTER TABLE `sampling_geometry` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`sampling_geometry_tr` BEFORE INSERT ON `sampling_geometry` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
CREATE TABLE `spectrum_datalink` (
  ...
  KEY `FK_spectrum_datalink_user_id` (`user_id`),
  ...
  CONSTRAINT `FK_spectrum_datalink_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`spectrum_datalink_tr` BEFORE INSERT ON `spectrum_datalink` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Temporary table structure for view `instrument_setting_view`
--

DROP TABLE IF EXISTS `instrument_setting_view`;
/*!50001 DROP VIEW IF EXISTS `instrument_setting_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `instrument_setting_view` (
  `instrument_setting_id` int(11),
  `value` float,
  `type` int(11),
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
...
--
-- Table structure for table `assoc_measurement`
--

DROP TABLE IF EXISTS `assoc_measurement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `assoc_measurement` (
  `assoc_measurement_id` int(11) NOT NULL AUTO_INCREMENT,
  `value` float DEFAULT NULL,
  `description` varchar(100) DEFAULT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `unit_id` int(11) DEFAULT '0',
  PRIMARY KEY (`assoc_measurement_id`),
  KEY `assoc_m_fk1` (`unit_id`),
  KEY `assoc_user_fk` (`user_id`),
  CONSTRAINT `assoc_user_fk` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
  CONSTRAINT `assoc_m_fk1` FOREIGN KEY (`unit_id`) REFERENCES `unit` (`unit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `assoc_measurement`
--

LOCK TABLES `assoc_measurement` WRITE;
/*!40000 ALTER TABLE `assoc_measurement` DISABLE KEYS */;
/*!40000 ALTER TABLE `assoc_measurement` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sdb_admin`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`assoc_measurement_tr` BEFORE INSERT ON `assoc_measurement` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Temporary table structure for view `picture_view`
--

DROP TABLE IF EXISTS `picture_view`;
/*!50001 DROP VIEW IF EXISTS `picture_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `picture_view` (
...
CREATE TABLE `eav` (
  ...
  KEY `fk_eav_specchio_user1` (`user_id`),
  ...
  CONSTRAINT `fk_eav_specchio_user1` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`) ON UPDATE NO ACTION,
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sdb_admin`@`localhost`*/ /*!50003 trigger eav_tr before insert on eav for each row set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Temporary table structure for view `spectrum_x_target_type_view`
--

DROP TABLE IF EXISTS `spectrum_x_target_type_view`;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_target_type_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `spectrum_x_target_type_view` (
  `spectrum_id` int(11),
  `target_type_id` int(10) unsigned,
  `abundance` float,
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `hierarchy_level` (
  ...
  KEY `FK_hierarchy_level_user_id` (`user_id`),
  CONSTRAINT `FK_hierarchy_level_parent` FOREIGN KEY (`parent_level_id`) REFERENCES `hierarchy_level` (`hierarchy_level_id`),
  CONSTRAINT `FK_hierarchy_level_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`hierarchy_level_tr` BEFORE INSERT ON `hierarchy_level` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Table structure for table `spectrum_x_target_type`
--

DROP TABLE IF EXISTS `spectrum_x_target_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spectrum_x_target_type` (
  `spectrum_id` int(11) NOT NULL,
  `target_type_id` int(10) unsigned NOT NULL,
  `abundance` float DEFAULT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`spectrum_id`,`target_type_id`),
  KEY `target_type_id` (`target_type_id`),
  KEY `FK_spectrum_x_target_type_user_id` (`user_id`),
  CONSTRAINT `FK_spectrum_x_target_type_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
  CONSTRAINT `spectrum_x_target_type_ibfk_1` FOREIGN KEY (`spectrum_id`) REFERENCES `spectrum` (`spectrum_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `spectrum_x_target_type_ibfk_2` FOREIGN KEY (`target_type_id`) REFERENCES `target_type` (`target_type_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spectrum_x_target_type`
--

LOCK TABLES `spectrum_x_target_type` WRITE;
/*!40000 ALTER TABLE `spectrum_x_target_type` DISABLE KEYS */;
/*!40000 ALTER TABLE `spectrum_x_target_type` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`spectrum_x_target_type_tr` BEFORE INSERT ON `spectrum_x_target_type` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Table structure for table `instr_setting_type`
--

DROP TABLE IF EXISTS `instr_setting_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `instr_setting_type` (
  `instr_setting_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) NOT NULL,
  PRIMARY KEY (`instr_setting_type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `instr_setting_type`
--

LOCK TABLES `instr_setting_type` WRITE;
/*!40000 ALTER TABLE `instr_setting_type` DISABLE KEYS */;
INSERT INTO `instr_setting_type` VALUES (1,'Gain_SWIR1'),(2,'Gain_SWIR2'),(3,'Integration_time'),(4,'Time_since_last_dc'),(5,'Offset_SWIR1'),(6,'Offset_SWIR2');
/*!40000 ALTER TABLE `instr_setting_type` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Temporary table structure for view `spectrum_x_assoc_measurement_view`
--

DROP TABLE IF EXISTS `spectrum_x_assoc_measurement_view`;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_assoc_measurement_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `spectrum_x_assoc_measurement_view` (
  `spectrum_id` int(11),
  `assoc_measurement_id` int(11),
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary table structure for view `assoc_measurement_view`
--

DROP TABLE IF EXISTS `assoc_measurement_view`;
/*!50001 DROP VIEW IF EXISTS `assoc_measurement_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `assoc_measurement_view` (
  `assoc_measurement_id` int(11),
  `value` float,
...
INSERT INTO `specchio_user` VALUES (1,'sdb_admin','','sdb_admin',NULL,'',NULL,NULL,1);
...
CREATE TABLE `wind_speed` (
  `wind_speed_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `speed` varchar(20) DEFAULT NULL,
  `description` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`wind_speed_id`)
...
LOCK TABLES `wind_speed` WRITE;
/*!40000 ALTER TABLE `wind_speed` DISABLE KEYS */;
INSERT INTO `wind_speed` VALUES (1,'calm',NULL),(2,'windy',NULL),(3,'stormy',NULL);
/*!40000 ALTER TABLE `wind_speed` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `spectrum_x_picture`
--

DROP TABLE IF EXISTS `spectrum_x_picture`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spectrum_x_picture` (
  `picture_id` int(10) unsigned NOT NULL,
  `spectrum_id` int(11) NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`picture_id`,`spectrum_id`),
  KEY `spectrum_id` (`spectrum_id`),
  KEY `FK_spectrum_x_picture_user_id` (`user_id`),
  CONSTRAINT `FK_spectrum_x_picture_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
  CONSTRAINT `spectrum_x_picture_ibfk_1` FOREIGN KEY (`picture_id`) REFERENCES `picture` (`picture_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `spectrum_x_picture_ibfk_2` FOREIGN KEY (`spectrum_id`) REFERENCES `spectrum` (`spectrum_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spectrum_x_picture`
--

LOCK TABLES `spectrum_x_picture` WRITE;
/*!40000 ALTER TABLE `spectrum_x_picture` DISABLE KEYS */;
/*!40000 ALTER TABLE `spectrum_x_picture` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`spectrum_x_picture_tr` BEFORE INSERT ON `spectrum_x_picture` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Table structure for table `spectrum_x_spectrum_name`
--

DROP TABLE IF EXISTS `spectrum_x_spectrum_name`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spectrum_x_spectrum_name` (
  `spectrum_id` int(11) NOT NULL,
  `spectrum_name_id` int(11) NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`spectrum_id`,`spectrum_name_id`),
  KEY `spectrum_x_spectrum_name_ibfk_2` (`spectrum_name_id`),
  KEY `FK_spectrum_x_spectrum_name_user_id` (`user_id`),
  CONSTRAINT `FK_spectrum_x_spectrum_name_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
  CONSTRAINT `spectrum_x_spectrum_name_ibfk_1` FOREIGN KEY (`spectrum_id`) REFERENCES `spectrum` (`spectrum_id`) ON DELETE CASCADE,
  CONSTRAINT `spectrum_x_spectrum_name_ibfk_2` FOREIGN KEY (`spectrum_name_id`) REFERENCES `spectrum_name` (`spectrum_name_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spectrum_x_spectrum_name`
--

LOCK TABLES `spectrum_x_spectrum_name` WRITE;
/*!40000 ALTER TABLE `spectrum_x_spectrum_name` DISABLE KEYS */;
/*!40000 ALTER TABLE `spectrum_x_spectrum_name` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`spectrum_x_spectrum_name_tr` BEFORE INSERT ON `spectrum_x_spectrum_name` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
CREATE TABLE `target_type` (
  `target_type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `target_category_id` int(10) unsigned NOT NULL,
  `name` varchar(45) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`target_type_id`),
  KEY `target_category_id` (`target_category_id`),
  CONSTRAINT `target_type_ibfk_1` FOREIGN KEY (`target_category_id`) REFERENCES `target_category` (`target_category_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `target_type` VALUES (1,1,'Tree',NULL),(2,1,'Pasture',NULL),(3,1,'Snow',NULL),(4,1,'Sand',NULL),(5,2,'Asphalt',NULL),(6,1,'Gravel',NULL),(7,2,'Tennis',NULL);
...
--
-- Table structure for table `spectrum_name_type`
--

DROP TABLE IF EXISTS `spectrum_name_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spectrum_name_type` (
  `spectrum_name_type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`spectrum_name_type_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spectrum_name_type`
--

LOCK TABLES `spectrum_name_type` WRITE;
/*!40000 ALTER TABLE `spectrum_name_type` DISABLE KEYS */;
INSERT INTO `spectrum_name_type` VALUES (1,'Common'),(2,'Latin'),(3,'ENVI Hdr');
/*!40000 ALTER TABLE `spectrum_name_type` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `spectrum_name`
--

DROP TABLE IF EXISTS `spectrum_name`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spectrum_name` (
  `spectrum_name_id` int(11) NOT NULL AUTO_INCREMENT,
  `spectrum_name_type_id` int(10) unsigned NOT NULL,
  `name` varchar(100) DEFAULT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`spectrum_name_id`),
  KEY `spectrum_name_type_id` (`spectrum_name_type_id`),
  KEY `FK_spectrum_name_user_id` (`user_id`),
  CONSTRAINT `FK_spectrum_name_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
  CONSTRAINT `spectrum_name_ibfk_1` FOREIGN KEY (`spectrum_name_type_id`) REFERENCES `spectrum_name_type` (`spectrum_name_type_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spectrum_name`
--

LOCK TABLES `spectrum_name` WRITE;
/*!40000 ALTER TABLE `spectrum_name` DISABLE KEYS */;
/*!40000 ALTER TABLE `spectrum_name` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`spectrum_name_tr` BEFORE INSERT ON `spectrum_name` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
INSERT INTO `attribute` VALUES (1,'time shift',NULL,1,NULL,'string_val'),(2,'data usage policy',NULL,3,NULL,'string_val');
...
CREATE TABLE `wind_direction` (
  `wind_direction_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `wind_direction` WRITE;
/*!40000 ALTER TABLE `wind_direction` DISABLE KEYS */;
INSERT INTO `wind_direction` VALUES (1,'N',NULL),(2,'NE',NULL),(3,'E',NULL),(4,'SE',NULL),(5,'S',NULL),(6,'SW',NULL),(7,'W',NULL),(8,'NW',NULL);
/*!40000 ALTER TABLE `wind_direction` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `position_view`
--

DROP TABLE IF EXISTS `position_view`;
/*!50001 DROP VIEW IF EXISTS `position_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `position_view` (
...
CREATE TABLE `spectrum` (
  ...
  `foreoptic_id` int(10) unsigned DEFAULT NULL,
  ...
  `sampling_geometry_id` int(10) unsigned DEFAULT NULL,
  `environmental_condition_id` int(10) unsigned DEFAULT NULL,
  `position_id` int(10) unsigned DEFAULT NULL,
  `landcover_id` int(10) unsigned DEFAULT NULL,
  `number` int(11) DEFAULT NULL,
  `measurement` blob,
  `file_comment` varchar(160) DEFAULT NULL,
  `date` datetime DEFAULT NULL,
  `file_name` varchar(100) DEFAULT NULL,
  `internal_average_cnt` int(10) unsigned DEFAULT NULL,
  ...
  KEY `environmental_condition_id` (`environmental_condition_id`),
  KEY `sampling_geometry_id` (`sampling_geometry_id`),
  ...
  CONSTRAINT `FK_spectrum_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
  ...
  CONSTRAINT `spectrum_ibfk_13` FOREIGN KEY (`foreoptic_id`) REFERENCES `foreoptic` (`foreoptic_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `spectrum_ibfk_16` FOREIGN KEY (`position_id`) REFERENCES `position` (`position_id`),
  ...
  CONSTRAINT `spectrum_ibfk_7` FOREIGN KEY (`environmental_condition_id`) REFERENCES `environmental_condition` (`environmental_condition_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `spectrum_ibfk_8` FOREIGN KEY (`sampling_geometry_id`) REFERENCES `sampling_geometry` (`sampling_geometry_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`spectrum_tr` BEFORE INSERT ON `spectrum` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
CREATE TABLE `hierarchy_level_x_spectrum` (
  ...
  KEY `hierarchy_level_x_spectrum_fk3` (`user_id`),
  ...
  CONSTRAINT `hierarchy_level_x_spectrum_fk3` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`) ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sdb_admin`@`localhost`*/ /*!50003 trigger hierarchy_level_x_spectrum_tr before insert on hierarchy_level_x_spectrum for each row set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Table structure for table `hierarchy_datalink`
--

DROP TABLE IF EXISTS `hierarchy_datalink`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `hierarchy_datalink` (
  `hierarchy_datalink_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `hierarchy_level_id` int(11) NOT NULL,
  `datalink_type_id` int(10) unsigned NOT NULL,
  `linked_hierarchy_level_id` int(11) NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`hierarchy_datalink_id`),
  KEY `datalink_type_id` (`datalink_type_id`),
  KEY `hierarchy_level_id` (`hierarchy_level_id`),
  KEY `FK_hierarchy_datalink_user_id` (`user_id`),
  KEY `linked_hierarchy_level_id` (`linked_hierarchy_level_id`),
  CONSTRAINT `FK_datalink_type` FOREIGN KEY (`datalink_type_id`) REFERENCES `datalink_type` (`datalink_type_id`),
  CONSTRAINT `FK_hierarchy_datalink_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`),
  CONSTRAINT `FK_hierarchy_level` FOREIGN KEY (`hierarchy_level_id`) REFERENCES `hierarchy_level` (`hierarchy_level_id`),
  CONSTRAINT `FK_linked_hierarchy_level` FOREIGN KEY (`linked_hierarchy_level_id`) REFERENCES `hierarchy_level` (`hierarchy_level_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hierarchy_datalink`
--

LOCK TABLES `hierarchy_datalink` WRITE;
/*!40000 ALTER TABLE `hierarchy_datalink` DISABLE KEYS */;
/*!40000 ALTER TABLE `hierarchy_datalink` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`hierarchy_datalink_tr` BEFORE INSERT ON `hierarchy_datalink` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
INSERT INTO `category` VALUES (1,'system','specchio'),(2,'system','input file'),(3,'user','manual input');
...
--
-- Temporary table structure for view `sampling_geometry_view`
--

DROP TABLE IF EXISTS `sampling_geometry_view`;
/*!50001 DROP VIEW IF EXISTS `sampling_geometry_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `sampling_geometry_view` (
  `sampling_geometry_id` int(10) unsigned,
  `sensor_zenith` float,
  `sensor_azimuth` float,
  `illumination_zenith` float,
  `illumination_azimuth` float,
  `sensor_distance` float,
  `illumination_distance` float,
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `spectrum_x_spectrum_name_view`
--

DROP TABLE IF EXISTS `spectrum_x_spectrum_name_view`;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_spectrum_name_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `spectrum_x_spectrum_name_view` (
  `spectrum_id` int(11),
  `spectrum_name_id` int(11),
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Temporary table structure for view `spectrum_x_picture_view`
--

DROP TABLE IF EXISTS `spectrum_x_picture_view`;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_picture_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `spectrum_x_picture_view` (
  `picture_id` int(10) unsigned,
  `spectrum_id` int(11),
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
...
CREATE TABLE `picture` (
  ...
  CONSTRAINT `FK_picture_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`picture_tr` BEFORE INSERT ON `picture` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
/*!50001 CREATE TABLE `spectrum_view` (
  ...
  `internal_average_cnt` int(10) unsigned,
...
--
-- Temporary table structure for view `spectrum_name_view`
--

DROP TABLE IF EXISTS `spectrum_name_view`;
/*!50001 DROP VIEW IF EXISTS `spectrum_name_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `spectrum_name_view` (
  `spectrum_name_id` int(11),
  `spectrum_name_type_id` int(10) unsigned,
  `name` varchar(100),
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Table structure for table `foreoptic`
--

DROP TABLE IF EXISTS `foreoptic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `foreoptic` (
  `foreoptic_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `sensor_id` int(11) NOT NULL,
  `degrees` int(10) unsigned NOT NULL,
  PRIMARY KEY (`foreoptic_id`),
  KEY `sensor_id` (`sensor_id`),
  CONSTRAINT `foreoptic_ibfk_1` FOREIGN KEY (`sensor_id`) REFERENCES `sensor` (`sensor_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `foreoptic`
--

LOCK TABLES `foreoptic` WRITE;
/*!40000 ALTER TABLE `foreoptic` DISABLE KEYS */;
INSERT INTO `foreoptic` VALUES (1,3,3),(2,3,25),(3,10,14),(4,10,4),(5,10,25),(6,10,180);
/*!40000 ALTER TABLE `foreoptic` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `position` (
  ...
  KEY `FK_position_user_id` (`user_id`),
  CONSTRAINT `FK_position_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`position_tr` BEFORE INSERT ON `position` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Temporary table structure for view `hierarchy_datalink_view`
--

DROP TABLE IF EXISTS `hierarchy_datalink_view`;
/*!50001 DROP VIEW IF EXISTS `hierarchy_datalink_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `hierarchy_datalink_view` (
  `hierarchy_datalink_id` int(10) unsigned,
  `hierarchy_level_id` int(11),
  `datalink_type_id` int(10) unsigned,
  `linked_hierarchy_level_id` int(11),
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
--
-- Table structure for table `spectrum_x_assoc_measurement`
--

DROP TABLE IF EXISTS `spectrum_x_assoc_measurement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spectrum_x_assoc_measurement` (
  `spectrum_id` int(11) NOT NULL,
  `assoc_measurement_id` int(11) NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`spectrum_id`,`assoc_measurement_id`),
  KEY `spectrum_x_assoc_measurement_fk2` (`assoc_measurement_id`),
  CONSTRAINT `spectrum_x_assoc_measurement_fk1` FOREIGN KEY (`spectrum_id`) REFERENCES `spectrum` (`spectrum_id`),
  CONSTRAINT `spectrum_x_assoc_measurement_fk2` FOREIGN KEY (`assoc_measurement_id`) REFERENCES `assoc_measurement` (`assoc_measurement_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spectrum_x_assoc_measurement`
--

LOCK TABLES `spectrum_x_assoc_measurement` WRITE;
/*!40000 ALTER TABLE `spectrum_x_assoc_measurement` DISABLE KEYS */;
/*!40000 ALTER TABLE `spectrum_x_assoc_measurement` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sdb_admin`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`spectrum_x_assoc_measurement_tr` BEFORE INSERT ON `spectrum_x_assoc_measurement` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Temporary table structure for view `spectrum_x_instr_setting_view`
--

DROP TABLE IF EXISTS `spectrum_x_instr_setting_view`;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_instr_setting_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `spectrum_x_instr_setting_view` (
  `spectrum_id` int(11),
  `instrument_setting_id` int(11),
  `user_id` int(10) unsigned
) ENGINE=MyISAM */;
...
--
-- Table structure for table `spectrum_x_instr_setting`
--

DROP TABLE IF EXISTS `spectrum_x_instr_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spectrum_x_instr_setting` (
  `spectrum_id` int(11) NOT NULL,
  `instrument_setting_id` int(11) NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`spectrum_id`,`instrument_setting_id`),
  KEY `instr_setting_fk` (`instrument_setting_id`),
  KEY `user_fk` (`user_id`),
  CONSTRAINT `spectrum_fk` FOREIGN KEY (`spectrum_id`) REFERENCES `spectrum` (`spectrum_id`),
  CONSTRAINT `instr_setting_fk` FOREIGN KEY (`instrument_setting_id`) REFERENCES `instrument_setting` (`instrument_setting_id`),
  CONSTRAINT `user_fk` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spectrum_x_instr_setting`
--

LOCK TABLES `spectrum_x_instr_setting` WRITE;
/*!40000 ALTER TABLE `spectrum_x_instr_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `spectrum_x_instr_setting` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sdb_admin`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`spectrum_x_instr_setting_tr` BEFORE INSERT ON `spectrum_x_instr_setting` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
CREATE TABLE `spectrum_x_eav` (
  ...
  KEY `spectrum_x_eav_fk3` (`user_id`),
  ...
  CONSTRAINT `spectrum_x_eav_fk3` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`) ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sdb_admin`@`localhost`*/ /*!50003 trigger spectrum_x_eav_tr before insert on spectrum_x_eav for each row set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Table structure for table `environmental_condition`
--
...
CREATE TABLE `environmental_condition` (
  `environmental_condition_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ambient_temperature` float DEFAULT NULL,
  `air_pressure` int(10) unsigned DEFAULT NULL,
  `relative_humidity` float DEFAULT NULL,
  `wind_direction_id` int(10) unsigned DEFAULT NULL,
  `wind_speed_id` int(10) unsigned DEFAULT NULL,
  `cloud_cover_id` int(10) unsigned DEFAULT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`environmental_condition_id`),
  KEY `wind_direction_id` (`wind_direction_id`),
  KEY `wind_speed_id` (`wind_speed_id`),
  KEY `FK_environmental_condition_3` (`cloud_cover_id`),
  KEY `FK_environmental_condition_user_id` (`user_id`),
  CONSTRAINT `environmental_condition_ibfk_1` FOREIGN KEY (`wind_direction_id`) REFERENCES `wind_direction` (`wind_direction_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `environmental_condition_ibfk_2` FOREIGN KEY (`wind_speed_id`) REFERENCES `wind_speed` (`wind_speed_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_environmental_condition_3` FOREIGN KEY (`cloud_cover_id`) REFERENCES `cloud_cover` (`cloud_cover_id`),
  CONSTRAINT `FK_environmental_condition_user_id` FOREIGN KEY (`user_id`) REFERENCES `specchio_user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=FIXED;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `environmental_condition`
--

LOCK TABLES `environmental_condition` WRITE;
/*!40000 ALTER TABLE `environmental_condition` DISABLE KEYS */;
/*!40000 ALTER TABLE `environmental_condition` ENABLE KEYS */;
UNLOCK TABLES;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER  `specchio`.`environmental_condition_tr` BEFORE INSERT ON `environmental_condition` FOR EACH ROW set new.user_id = (select user_id from specchio_user where user = SUBSTRING_INDEX((select user()), '@', 1)) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
--
-- Final view structure for view `environmental_condition_view`
--

/*!50001 DROP TABLE IF EXISTS `environmental_condition_view`*/;
/*!50001 DROP VIEW IF EXISTS `environmental_condition_view`*/;
...
/*!50001 VIEW `environmental_condition_view` AS select `environmental_condition`.`environmental_condition_id` AS `environmental_condition_id`,`environmental_condition`.`ambient_temperature` AS `ambient_temperature`,`environmental_condition`.`air_pressure` AS `air_pressure`,`environmental_condition`.`relative_humidity` AS `relative_humidity`,`environmental_condition`.`wind_direction_id` AS `wind_direction_id`,`environmental_condition`.`wind_speed_id` AS `wind_speed_id`,`environmental_condition`.`cloud_cover_id` AS `cloud_cover_id`,`environmental_condition`.`user_id` AS `user_id` from `environmental_condition` where (`environmental_condition`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
...
--
-- Final view structure for view `instrument_setting_view`
--

/*!50001 DROP TABLE IF EXISTS `instrument_setting_view`*/;
/*!50001 DROP VIEW IF EXISTS `instrument_setting_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`sdb_admin`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `instrument_setting_view` AS select `instrument_setting`.`instrument_setting_id` AS `instrument_setting_id`,`instrument_setting`.`value` AS `value`,`instrument_setting`.`type` AS `type`,`instrument_setting`.`user_id` AS `user_id` from `instrument_setting` where (`instrument_setting`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `picture_view`
--

/*!50001 DROP TABLE IF EXISTS `picture_view`*/;
/*!50001 DROP VIEW IF EXISTS `picture_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `picture_view` AS select `picture`.`picture_id` AS `picture_id`,`picture`.`caption` AS `caption`,`picture`.`image_data` AS `image_data`,`picture`.`user_id` AS `user_id` from `picture` where (`picture`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `campaign_view` AS select `campaign`.`campaign_id` AS `campaign_id`,`campaign`.`name` AS `name`,`campaign`.`description` AS `description`,`campaign`.`path` AS `path`,`campaign`.`quality_comply` AS `quality_comply`,`campaign`.`user_id` AS `user_id` from `campaign` where (`campaign`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `spectrum_x_target_type_view`
--

/*!50001 DROP TABLE IF EXISTS `spectrum_x_target_type_view`*/;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_target_type_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `spectrum_x_target_type_view` AS select `spectrum_x_target_type`.`spectrum_id` AS `spectrum_id`,`spectrum_x_target_type`.`target_type_id` AS `target_type_id`,`spectrum_x_target_type`.`abundance` AS `abundance`,`spectrum_x_target_type`.`user_id` AS `user_id` from `spectrum_x_target_type` where (`spectrum_x_target_type`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `spectrum_x_assoc_measurement_view`
--

/*!50001 DROP TABLE IF EXISTS `spectrum_x_assoc_measurement_view`*/;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_assoc_measurement_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`sdb_admin`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `spectrum_x_assoc_measurement_view` AS select `spectrum_x_assoc_measurement`.`spectrum_id` AS `spectrum_id`,`spectrum_x_assoc_measurement`.`assoc_measurement_id` AS `assoc_measurement_id`,`spectrum_x_assoc_measurement`.`user_id` AS `user_id` from `spectrum_x_assoc_measurement` where (`spectrum_x_assoc_measurement`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `assoc_measurement_view`
--

/*!50001 DROP TABLE IF EXISTS `assoc_measurement_view`*/;
/*!50001 DROP VIEW IF EXISTS `assoc_measurement_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`sdb_admin`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `assoc_measurement_view` AS select `assoc_measurement`.`assoc_measurement_id` AS `assoc_measurement_id`,`assoc_measurement`.`value` AS `value`,`assoc_measurement`.`description` AS `description`,`assoc_measurement`.`user_id` AS `user_id`,`assoc_measurement`.`unit_id` AS `unit_id` from `assoc_measurement` where (`assoc_measurement`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `position_view`
--

/*!50001 DROP TABLE IF EXISTS `position_view`*/;
/*!50001 DROP VIEW IF EXISTS `position_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `position_view` AS select `position`.`position_id` AS `position_id`,`position`.`longitude` AS `longitude`,`position`.`latitude` AS `latitude`,`position`.`altitude` AS `altitude`,`position`.`location_name` AS `location_name`,`position`.`user_id` AS `user_id` from `position` where (`position`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `spectrum_datalink_view` AS select `spectrum_datalink`.`spectrum_datalink_id` AS `spectrum_datalink_id`,`spectrum_datalink`.`datalink_type_id` AS `datalink_type_id`,`spectrum_datalink`.`spectrum_id` AS `spectrum_id`,`spectrum_datalink`.`linked_spectrum_id` AS `linked_spectrum_id`,`spectrum_datalink`.`user_id` AS `user_id` from `spectrum_datalink` where (`spectrum_datalink`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `sampling_geometry_view`
--

/*!50001 DROP TABLE IF EXISTS `sampling_geometry_view`*/;
/*!50001 DROP VIEW IF EXISTS `sampling_geometry_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `sampling_geometry_view` AS select `sampling_geometry`.`sampling_geometry_id` AS `sampling_geometry_id`,`sampling_geometry`.`sensor_zenith` AS `sensor_zenith`,`sampling_geometry`.`sensor_azimuth` AS `sensor_azimuth`,`sampling_geometry`.`illumination_zenith` AS `illumination_zenith`,`sampling_geometry`.`illumination_azimuth` AS `illumination_azimuth`,`sampling_geometry`.`sensor_distance` AS `sensor_distance`,`sampling_geometry`.`illumination_distance` AS `illumination_distance`,`sampling_geometry`.`user_id` AS `user_id` from `sampling_geometry` where (`sampling_geometry`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `spectrum_x_spectrum_name_view`
--

/*!50001 DROP TABLE IF EXISTS `spectrum_x_spectrum_name_view`*/;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_spectrum_name_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `spectrum_x_spectrum_name_view` AS select `spectrum_x_spectrum_name`.`spectrum_id` AS `spectrum_id`,`spectrum_x_spectrum_name`.`spectrum_name_id` AS `spectrum_name_id`,`spectrum_x_spectrum_name`.`user_id` AS `user_id` from `spectrum_x_spectrum_name` where (`spectrum_x_spectrum_name`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `spectrum_x_picture_view`
--

/*!50001 DROP TABLE IF EXISTS `spectrum_x_picture_view`*/;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_picture_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `spectrum_x_picture_view` AS select `spectrum_x_picture`.`picture_id` AS `picture_id`,`spectrum_x_picture`.`spectrum_id` AS `spectrum_id`,`spectrum_x_picture`.`user_id` AS `user_id` from `spectrum_x_picture` where (`spectrum_x_picture`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `spectrum_name_view`
--

/*!50001 DROP TABLE IF EXISTS `spectrum_name_view`*/;
/*!50001 DROP VIEW IF EXISTS `spectrum_name_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `spectrum_name_view` AS select `spectrum_name`.`spectrum_name_id` AS `spectrum_name_id`,`spectrum_name`.`spectrum_name_type_id` AS `spectrum_name_type_id`,`spectrum_name`.`name` AS `name`,`spectrum_name`.`user_id` AS `user_id` from `spectrum_name` where (`spectrum_name`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `hierarchy_datalink_view`
--

/*!50001 DROP TABLE IF EXISTS `hierarchy_datalink_view`*/;
/*!50001 DROP VIEW IF EXISTS `hierarchy_datalink_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `hierarchy_datalink_view` AS select `hierarchy_datalink`.`hierarchy_datalink_id` AS `hierarchy_datalink_id`,`hierarchy_datalink`.`hierarchy_level_id` AS `hierarchy_level_id`,`hierarchy_datalink`.`datalink_type_id` AS `datalink_type_id`,`hierarchy_datalink`.`linked_hierarchy_level_id` AS `linked_hierarchy_level_id`,`hierarchy_datalink`.`user_id` AS `user_id` from `hierarchy_datalink` where (`hierarchy_datalink`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),_utf8'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `spectrum_x_instr_setting_view`
--

/*!50001 DROP TABLE IF EXISTS `spectrum_x_instr_setting_view`*/;
/*!50001 DROP VIEW IF EXISTS `spectrum_x_instr_setting_view`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`sdb_admin`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `spectrum_x_instr_setting_view` AS select `spectrum_x_instr_setting`.`spectrum_id` AS `spectrum_id`,`spectrum_x_instr_setting`.`instrument_setting_id` AS `instrument_setting_id`,`spectrum_x_instr_setting`.`user_id` AS `user_id` from `spectrum_x_instr_setting` where (`spectrum_x_instr_setting`.`user_id` = (select `specchio_user`.`user_id` AS `user_id` from `specchio_user` where (`specchio_user`.`user` = convert(convert((select substring_index((select user() AS `user()`),'@',1) AS `SUBSTRING_INDEX((select user()), '@', 1)`) using latin1) using utf8)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2012-05-31 11:36:33
